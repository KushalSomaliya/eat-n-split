...
export default function App() {
  ...
  function handleSplitBill(value) {
    setFriends((friends) =>
      friends.map((friend) => {
        if (friend !== selectedFriend) return friend;
...
function FormSplitBill({ selectedFriend, onSplitBill }) {
  ...
  function handleSetBill(e) {
    ...
    if (userExpense > newValue) setUserExpense(newValue);
  ...
  function handleSetUserExpense(e) {
    ...
    setUserExpense(newValue > bill ? userExpense : newValue);
  }
  ...
  return (
    <form className="form-split-bill" onSubmit={handleSubmit}>
      ...
      <input type="text" value={userExpense} onChange={handleSetUserExpense} />
